    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                @if(config('kodatik.locale.status') && count(config('kodatik.locale.languages')) > 1)
                ...
                @guest
                    ...
                    @if (config('kodatik.access.user.registration'))
                        <li class="nav-item">
                            <x-utils.link
...
@if (config('kodatik.frontend_breadcrumbs'))
