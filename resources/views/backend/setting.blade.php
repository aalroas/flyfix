...
@else
<link rel="stylesheet" href="{{ asset(mix('rtl-css/plugins/forms/validation/form-validation.css')) }}">
@endlangrtl
<link rel="stylesheet" href="{{asset('common/dropify/css/dropify.min.css') }}">
                  ...
                  <div class="card">
                    ...
                    <div class="body">
                      <div class="form-group">
                        <div class="controls">
                          <input type="file" class="dropify" data-default-file="{{ asset($Setting->site_logo) }}"
                            data-allowed-file-extensions="png jpg jpeg" name="site_logo">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="card">
                    ...
                    <div class="body">
                      <div class="form-group">
                        <div class="controls">
                          <input type="file" class="dropify" data-default-file="{{ asset($Setting->site_icon) }}"
                            data-allowed-file-extensions="png jpg jpeg" name="site_icon">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-content">
                      <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTabactivity" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="settings-tr-tab" data-toggle="tab" href="#settings-tr"
                              role="tab" aria-controls="settings-tr" aria-selected="true">[
                              {{trans('languages.turkish')}} ]</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="settings-en-tab" data-toggle="tab" href="#settings-en" role="tab"
                              aria-controls="settings-en" aria-selected="true">[
                              {{trans('languages.english') }} ]</a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link" id="settings-ar-tab" data-toggle="tab" href="#settings-ar" role="tab"
                              aria-controls="settings-ar" aria-selected="true">[
                              {{trans('languages.arabic') }} ]</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="settings-fr-tab" data-toggle="tab" href="#settings-fr" role="tab"
                              aria-controls="settings-fr" aria-selected="true">[ {{trans('languages.french')}} ]</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="settings-fa-tab" data-toggle="tab" href="#settings-fa" role="tab"
                              aria-controls="settings-fa" aria-selected="true">[ {{trans('languages.persian')}} ]</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="settings-ru-tab" data-toggle="tab" href="#settings-ru" role="tab"
                              aria-controls="settings-ru" aria-selected="true">[ {{trans('languages.russian')}} ]</a>
                          </li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content pt-1">
                          <div class="tab-pane active" id="settings-tr" role="tabpanel" aria-labelledby="settings-tr">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="tr[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="tr[site_address]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="tr[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="tr[site_meta_keywords]" required
                          ...
                          <div class="tab-pane" id="settings-en" role="tabpanel" aria-labelledby="settings-en">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  <label for="site_title">{{ trans('backend.site_title') }}</label>
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="en[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="en[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="en[site_meta_keywords]" required
                          ...
                          <div class="tab-pane" id="settings-ar" role="tabpanel" aria-labelledby="settings-ar">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  <label for="site_title">{{ trans('backend.site_title') }}</label>
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="ar[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="ar[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="ar[site_meta_keywords]" required
                          ...
                          <div class="tab-pane" id="settings-fr" role="tabpanel" aria-labelledby="settings-fr">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  <label for="site_title">{{ trans('backend.site_title') }}</label>
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="fr[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="fr[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="fr[site_meta_keywords]" required
                          ...
                          <div class="tab-pane" id="settings-fa" role="tabpanel" aria-labelledby="settings-fa">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  <label for="site_title">{{ trans('backend.site_title') }}</label>
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="fa[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="fa[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="fa[site_meta_keywords]" required
                          ...
                          <div class="tab-pane" id="settings-ru" role="tabpanel" aria-labelledby="settings-ru">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  <label for="site_title">{{ trans('backend.site_title') }}</label>
                                  <div class="form-group">
                                    <input type="text" class="form-control" required minlength="2" name="ru[site_title]"
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="ru[site_meta_description]" required
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <div class="form-group">
                                    <textarea data-length="2000" class="form-control char-textarea" rows="3"
                                      name="ru[site_meta_keywords]" required
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_email"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_mobile"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_phone"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_fax"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_whatsapp_url"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_instagram_url"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_facebook_url"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_twitter_url"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_linkedin_url"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" required minlength="2" name="site_youtube_url"
