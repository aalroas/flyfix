...
class UserController extends Controller
{
    ...
    $breadcrumbs = [
      ['link' => "dashboard", 'name' => "Home"], ['name' => "User List"]
    ];
    ...
    {
    $breadcrumbs = [
      ['link' => "dashboard", 'name' => "Home"], ['name' => "View User"]
    ];


        return view('backend.auth.user.show',compact('breadcrumbs'))
            ->withUser($user);
    }
    ...
    public function edit(EditUserRequest $request, User $user)
    {
      ...
      $breadcrumbs = [
        ['link' => "dashboard", 'name' => "Home"], ['name' => "User Edit"]
      ];

        return view('backend.auth.user.edit',compact('breadcrumbs'))
            ->withUser($user)
            ->withRoles($this->roleService->get())
            ->withCategories($this->permissionService->getCategorizedPermissions())
            ->withGeneral($this->permissionService->getUncategorizedPermissions())
