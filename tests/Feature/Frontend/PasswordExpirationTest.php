...
class PasswordExpirationTest extends TestCase
{
    ...
    {
        config(['kodatik.access.user.password_expires_days' => 30]);
    ...
    public function a_user_with_an_expired_password_cannot_access_dashboard()
    {
        ...
        $response->assertSessionHas('flash_warning', __('Your password has expired. We require you to change your password every '.config('kodatik.access.user.password_expires_days').' days for security purposes.'));
    }
