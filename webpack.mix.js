...
const domain = "admin.app"; // <= EDIT THIS
...
mix.browserSync({
  ...
  https: {
    key:
      "/Users/abdulsalamalroas/.config/valet/Certificates/" + domain + ".key",
    cert:
      "/Users/abdulsalamalroas/.config/valet/Certificates/" + domain + ".crt",
  },
});
